...
- When using Edit, copy `old_string` verbatim from your latest Read or Edit response snippet (text after the line-number tab). Do not reformat HTML, CSS, or indentation.
